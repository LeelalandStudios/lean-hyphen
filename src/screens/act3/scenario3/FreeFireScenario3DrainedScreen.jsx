import { PATH_SEND_FF_NOTICE } from "../../../content/scenario3.js";
import StatusBar from "../../../components/phone/StatusBar.jsx";

export default function FreeFireScenario3DrainedScreen() {
  return (
    <div className="relative h-full bg-gradient-to-b from-slate-700 to-slate-950 p-5 pt-16 text-white">
      ...
      <div className="mt-5 rounded-2xl bg-white/10 p-4 text-sm">📱 {PATH_SEND_FF_NOTICE}</div>
    </div>
  );
}
